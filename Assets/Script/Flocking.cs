...
public class Flocking : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        leder = target.GetComponent<Leader>();
    ...
    void FixedUpdate()
    {
        ...
        velocity = direction.normalized * weightToTarget;
        MoveTo();
    ...
    void MoveTo()
    {
        ...
        transform.rotation = new Quaternion(transform.rotation.x, Quaternion.Slerp(transform.rotation, rotation, maxTurnRate).y,
